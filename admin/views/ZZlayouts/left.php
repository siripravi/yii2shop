...
-->
    ...
    <!--?php
        ...
        <?= Menu::widget([
            'items' => [
                ['label' => 'Categories', 'icon' => 'dashboard', 'url' => ['/admin/products/category/index']],
                ['label' => 'Products', 'icon' => 'table_chart', 'url' => ['/admin/products/default/index']],
                ['label' => 'Groups', 'icon' => 'web', 'url' => ['/admin/products/complect/index']],
             
                ['label' => 'Units', 'icon' => 'notifications', 'url' => ['/admin/products/unit/index']],
                ['label' => 'Currencies', 'icon' => 'currency', 'url' => ['/admin/products/currency/index']],
                ['label' => 'Features', 'icon' => 'notifications', 'url' => ['/admin/products/feature/index']],
                ['label' => 'Customers', 'icon' => 'notifications', 'url' => ['/admin/buyer/index']],
                ['label' => 'Users', 'icon' => 'notifications', 'url' => ['/admin/user/index']],
                ['label' => 'statuses', 'icon' => 'notifications', 'url' => ['/admin/products/product-status/index']],
