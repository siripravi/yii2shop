...
namespace siripravi\slideradmin\components;
use yii;
use yii\base\Component;
use siripravi\slideradmin\models\SliderImage;
use siripravi\slideradmin\components\ImgException;
...
class ImgManager extends Component {
     ...
     */
    public function save($file, $name = null, $path = null, $id = null,$fk = null) {
        $trx = \Yii::$app->db->beginTransaction();
        try {
             if ($id > 0) {
                $image = \siripravi\slideradmin\models\SliderImage::findOne($id);
                $this->delete($id);
            } else
                $image = new \siripravi\slideradmin\models\SliderImage();
    ...
    protected function getBasePath() {
        if ($this->_basePath !== null)
           ...
           return $this->_basePath = realpath(\Yii::$app->basePath ). '\\' ;
			//return $this->_basePath = realpath(\Yii::$app->basePath . '/../') . '\\web\\';	
    }
