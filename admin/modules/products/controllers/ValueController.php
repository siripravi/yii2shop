...
namespace admin\modules\products\controllers;

use admin\modules\sortable\actions\SortingAction;
use Yii;
use admin\modules\products\models\Value;
use admin\modules\products\models\ValueSearch;
...
class ValueController extends BaseAdminController
{
    ...
    public function actionIndex()
    {
        ...
        $vsearch = Yii::$app->request->get('ValueSearch');
        $feature_id = ($vsearch) ? $vsearch['feature_id'] : null;
