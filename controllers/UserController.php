...
class UserController extends Controller
{
    ...
    public function actionView($id)
    {
      ...
      /*  $dataProvider = new ActiveDataProvider([
            'query' => Order::find()->hasUser($user)->available()->freshFirst(),
            'pagination' => ['pageSize' => Yii::$app->params['Order.pageSize']],
        ]);*/
    ...
    public function actionUpdate($id)
    {
        ...
        if (!UserPermissions::canManageUser($model)) {
            throw new ForbiddenHttpException(Yii::t('app', 'You can not update this user.'));
        }
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->uploadAvatar() && $model->save()) {
                ...
                Yii::$app->session->setFlash('error', Yii::t('app', 'Can not save your profile.'));
            }
        }
