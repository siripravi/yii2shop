                ...
                <?php
                    echo Carousel::widget([
                        ...
                        'options' => [       
                            ...
                            'controls' => [
                                '<span><iconify-icon icon="fontisto:angle-left" width="40" style="color:#FFF;"></iconify-icon></span>',
                                '<span><iconify-icon icon="fontisto:angle-right" width="40" style="color:#FFF;"></iconify-icon></span>',
                            ],
                    ]) ?>
                </div>
                <?php endif;  ?>   
