...
<section class="py-5">
                <div class="container px-5 my-5">
                    ...
                    <div class="text-muted" title="<?= Yii::t('app', 'Tags'); ?>">
                        ...
                        <div class="col-lg-9">
                            ...
                            <article>
                                ...
                                <header class="mb-4">
                                    ...
                                    <!-- Post meta content-->
									<time title="<?= Yii::t('app', 'Create Time'); ?>" itemprop="datePublished"
	...
	<?php if (Yii::$app->params['page']['enableComments']) : ?>
        ...
        <section id="comments" class="page-comments">
            <h2 class="page-comments__header title title--2"><?= Yii::t('app', 'Comments'); ?></h2>
