...
class CartWidget extends Widget
{
    ...
    public function run()
    {
        ...
        $a_head = Html::a(Yii::t('app', 'Items in Cart'), $this->urlCart, ['class' => 'text-white', 'data-modal' => Url::to(['/bag/modal'])]);

        $a_icon = Html::a(Html::tag('i', '', ['class' => 'fa fa-shopping-cart fa-2x fa-y pull-right']), $this->urlCart, ['data-modal' => Url::to(['/bag/modal'])]);
        ...
        $tr[] = Html::tag('tr', Html::tag('td',
            ...
            . Html::a(Yii::t('app', 'Place an order'), ['/bag/index'], ['class' => 'btn btn-warning btn-block btn-lg mt-3 px-1']),
            [
                'class' => 'border',
                'colspan' => 2,
            ]
